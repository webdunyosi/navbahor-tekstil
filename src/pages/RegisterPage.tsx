...
const RegisterPage = ({ onRegister, onGoLogin }: RegisterPageProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (storedUsers.find((u) => u.username === username.trim())) {
      setError('Bu foydalanuvchi nomi allaqachon band.');
      return;
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-purple-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 shadow-2xl p-8">
          <h2 className="text-xl font-semibold text-white mb-6">Ro'yhatdan o'tish</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm text-white/70 mb-1.5" htmlFor="reg-username">
                Foydalanuvchi nomi
              </label>
              <input
                id="reg-username"
            ...
            <div>
              <label className="block text-sm text-white/70 mb-1.5" htmlFor="reg-password">
                Parol
              </label>
              <input
                id="reg-password"
            ...
            <div>
              <label className="block text-sm text-white/70 mb-1.5" htmlFor="confirm-password">
                Parolni tasdiqlang
              </label>
              <input
                id="confirm-password"
